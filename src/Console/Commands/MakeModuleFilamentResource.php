...
#[AsCommand(name: 'lakasir-module:resource')]
class MakeModuleFilamentResource extends Command
{
    ...
    protected $signature = 'lakasir-module:resource {name?} {--model-namespace=} {--soft-deletes} {--view} {--G|generate} {--S|simple} {--panel=} {--model} {--migration} {--factory} {--F|force}';
    ...
    public function handle()
    {
        ...
        $path = "{$modulePath}\\src\\Filament\\Resources";
